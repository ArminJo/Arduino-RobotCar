...
*/
/**************************************************************************/
Adafruit_MotorShield::Adafruit_MotorShield(uint8_t addr) { // @suppress("Class members should be properly initialized")
  _addr = addr;
...
*/
/**************************************************************************/
Adafruit_StepperMotor::Adafruit_StepperMotor(void) { // @suppress("Class members should be properly initialized")
